...
namespace KnightsQuest
{
    class Program
    {
        ...
        {
            Console.WriteLine("Terve tuloa ritari peliin!");
            ...
            while (true)
            {
                ...
                if (choice == 1)
                {
                    ...
                    Console.WriteLine("3. Heltti potion (5 gold) (kun käytetty taistelussa lisää +20hp)");
                    ...
                    else
                    {
                        ...
                        if (valinta == 3)
                        {
                            Console.WriteLine("Ostit heltti potionin ja käytit 5 kultaa");
                            player.pottu++;
                            player.Money -= 5;
                        }
                        if (valinta == 4)
                ...
                if (choice == 2)
                {
                    while (!enemy.IsDefeated)
                    {
                        ...
                        Console.WriteLine($"3. Käytä HP potion (potionien määrä : {player.pottu})");
                        Console.WriteLine("4. lähde karkuun");
                        Console.Write("Valinta: ");
                            ...
                            case 3:
                                {
                                    ...
                                    if (player.pottu <= 0)
                                    {
                                        Console.WriteLine("Sinulla ei ole heltti potioneja");
                                    }
                                    break;
                                }
                            case 4:
                                Console.WriteLine("Lähdit karkuun taistelusta!");
                                return;
                            default:
                ...
                if (choice == 3)
                {
                    while (!enemy.IsDefeatedrit)
                    {
                        ...
                        Console.WriteLine();
                        Console.WriteLine($"Pelaajan heltti: {player.Health}");
                        Console.WriteLine($"Ritarin heltti: {enemy.Rithealth}");

                        
                        Console.WriteLine("Mitä aiot tehdä?");
                        Console.WriteLine("1. Hyökkää");
                        Console.WriteLine("2. Käytä abilitysi");
                        Console.WriteLine($"3. Käytä heltti potion (potionien määrä : {player.pottu})");
                ...
                if (choice == 4)
                {
                    while (!enemy.IsDefeatedloh)
                    {
                        ...
                        Console.WriteLine();
                        Console.WriteLine($"Pelaajan heltti: {player.Health}");
                        Console.WriteLine($"Lohikäärmeen heltti: {enemy.Lohhealth}");
